...
ROOT_URLCONF = 'representing_fineGrained_coOccurrences.urls'
...
WSGI_APPLICATION = 'representing_fineGrained_coOccurrences.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'representing_finegrained_cooccurrences',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
