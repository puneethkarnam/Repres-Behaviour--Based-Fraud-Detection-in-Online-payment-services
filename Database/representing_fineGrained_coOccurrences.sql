...
--
-- Host: localhost
-- Generation Time: Aug 13, 2022 at 07:39 AM
...
--
-- Database: `representing_finegrained_cooccurrences`
--
CREATE DATABASE IF NOT EXISTS `representing_finegrained_cooccurrences` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `representing_finegrained_cooccurrences`;
...
(31, 'Naive Bayes', '50.718002081165444'),
(32, 'SVM', '50.65556711758585'),
(33, 'Logistic Regression', '50.65556711758585'),
(34, 'Decision Tree Classifier', '50.65556711758585'),
(35, 'SGD Classifier', '50.73881373569199');
...
(12, 'No Fraud', '66.66666666666666'),
(13, 'Fraud', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_fraud_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_fraud_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_fraud_detection_type`
--

INSERT INTO `remote_user_fraud_detection_type` (`id`, `step`, `Product_name`, `type`, `amount`, `nameOrig`, `oldbalanceOrg`, `newbalanceOrig`, `nameDest`, `oldbalanceDest`, `newbalanceDest`, `Prediction`) VALUES
(1, '1', 'A27TZ4WBU7N0YF\n', 'PAYMENT', '7817.71', 'C90045638', '53860', '46042.29', 'M573487274', '0', '0', 'Fraud'),
(2, '1', 'A2W3ABLWMJ84NS\n', 'PAYMENT', '7107.77', 'C154988899', '183195', '176087.23', 'M408069119', '0', '0', 'No Fraud'),
(3, '1', 'AB30HQTI5VOLR', 'DEBIT', '9644.94', 'C1900366749', '4465', '0', 'C997608398', '10845', '157982.12', 'No Fraud');
